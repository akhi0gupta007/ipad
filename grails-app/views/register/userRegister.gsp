				...
				<div class="formBox">
					<div class="createUser formHeadingBg">
						...
						<g:else>
							...
							<div id="updateMessage"></div>
						<g:form id="userRegisterForm" name="userRegisterForm" url="[controller:'register',action:'update']">
							...
							<div class="formInput">		
								...
								name='name' id='name' value='${user.name }' disabled="disabled"/>
							</div>
							...
							<div class="formInput">	
								...
								id='email' value='${user.email }' disabled="disabled"/>
							</div>
							<div class="formInput">	
								...
								name='username' id='username' value='${user.username }' disabled="disabled"/>
