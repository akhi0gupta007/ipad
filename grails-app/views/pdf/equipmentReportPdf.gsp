				...
				<table class="fourSideBorder mainTable">
					<tr><td class="fullWidth ">
							<div class="fr width20Percent marginBottomReport">
								<p class="textPadding">Project nr. :${report.projectNumber } </p>
								<p class="textPadding">Datum : ${reviewDate }</p>
							</div>
							</td>
							</tr>
							<tr>
					...
					<tr>
						<td class="fullWidth">
							...
							<p class="addressMargin">Tel: ${report.building.project.customer.contact }</p>
							<p class="addressMargin">Fax: </p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td class="fullWidth ">
							<p class="tableFontThree"><g:message code="messages.report.end.result" /></p>
								...
								<div class="textPadding marginLeftRight fl fullWidth">
									<div class="fl textPadding"><g:message code="messages.report.indication.armatures.approved" />: </div><div class="fl textPadding">${totalEquipmentsIndication.size()  - totalIndicationRejected.size() }</div>
								</div>
								<div class="textPadding marginLeftRight fl fullWidth">
									<div class="fl textPadding"><g:message code="messages.report.lighting.armatures.approved" />: </div><div class="fl textPadding">${totalEquipmentsLighting.size() - totalLightingRejected.size() }</div>
								</div>
								<div class="textPadding marginLeftRight fl fullWidth">
									<div class="fl textPadding"><g:message code="messages.report.indication.armatures.rejected" />: </div><div class="fl textPadding">${totalIndicationRejected.size() }</div>
								</div>
								<div class="textPadding marginLeftRight fl fullWidth">
									<div class="fl textPadding"><g:message code="messages.report.lighting.armatures.rejected" />: </div><div class="fl textPadding">${totalLightingRejected.size() }</div>
								</div>
						</td>
					</tr>
					<tr>
									...
									<ul type="circle" class="marginLeftRight reportUl">
										<g:each in="${floorComment.value.toString().split('[.]') }" var="comment">
											<g:if test="${comment.trim()!='' }">
												<li class="marginLeftRight"> ${comment }</li>
											</g:if>
										</g:each>
									</ul>
								</g:if>
