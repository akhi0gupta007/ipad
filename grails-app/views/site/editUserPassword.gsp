	...
	<div class="formBox">
		...
		<div class="createUser formHeadingBg">
			...
			<g:form id="updateUserForm" name="updateUserForm" class="cmxform" url="[controller:'site',action:'updateUsers']" autocomplete='off'>
				...
				<div class="formInput">
					<label class="fl inputHeading"><g:message code="login.password.label"/>:</label>
						<input type="password" class="field" placeholder="<g:message code="login.password.label"/>" name='password'
							id='password' />
				</div>
				<div class="formInput">
					<label class="fl inputHeading"><g:message code="edit.user.repeat.password"/> :</label>
						<input type="password" class="field" placeholder="<g:message code="edit.user.repeat.password"/>" name='password2'
							id='password2' />
				</div>
				...
				<div class="formInput">
					<label class="fl inputHeading"><g:message code="users.Contact.Number"/> :</label>
						...
						<input type="text" class="field contact" placeholder="<g:message code="users.Contact.Number"/>" onblur="phone_validate(this.value);" name='mobile'
							...
							<input type="hidden" class="text" name='forwardTo' id='forwardTo' value="editUserPassword" />
