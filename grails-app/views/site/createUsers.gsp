...
<div class="customerList">
	<div class="formBox">
		<div class="createUser marginTopBottom formHeadingBg">
			<h2><g:message code="users.create.new.user"/> ${loggedinUser.customer.name }</h2>
				<g:form id="createUser" name="createUser" url="[controller:'site',action:'saveUser']">
					<h2 class="loginDetails "><g:message code="customer.account.details"/></h2>
				<div class="formInput">
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
        	$('#createUser').find('input[type=text]').val('');
